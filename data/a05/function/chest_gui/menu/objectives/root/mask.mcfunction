...
data modify storage ui mask set value [ \
  ...
  {Slot:9b,id:"minecraft:barrier",components:{"minecraft:item_model":"jukebox","minecraft:item_name":"Lobby Piano Songs","minecraft:custom_data":{ui_item:{cmd:"function a05:chest_gui/menu/objectives/music/open"}}}} \
]