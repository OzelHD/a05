...
execute if data storage ui in[0] run return run function a05:chest_gui/menu/on_input
...
execute if data storage ui in[0] unless data storage ui in[1] run return run function a05:chest_gui/menu/on_click

# Update Page & History if nothing happened
function a05:chest_gui/menu/refresh