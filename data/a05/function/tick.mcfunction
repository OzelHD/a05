...
function a05:mirror/detection

function a05:magic_crafting/check
function a05:chimney/detect_campfire

execute as @a run function a05:chest_gui/player/tick
execute as @e[type=chest_minecart,tag=ui] run function a05:chest_gui/minecart/tick
