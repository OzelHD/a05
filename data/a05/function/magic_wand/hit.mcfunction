...
execute if score @s show_debug_particles matches 1 run particle dust_color_transition{from_color:[1.0,1.0,1.0],to_color:[0.0,0.0,0.0],scale:0.6} ~ ~ ~ 0 0 0 0 4 force
