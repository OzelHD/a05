...
# Update reload text display with progressive coloring
execute as @a[scores={gun_reload_timer=1..}] run function a05:magic_gun/reload/update_reload_text

# Revert text when reload complete
execute as @a[scores={gun_reload_timer=0}] run function a05:magic_gun/reload/revert_reload_text
