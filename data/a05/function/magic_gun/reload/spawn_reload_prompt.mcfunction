...
execute unless entity @e[tag=reload_interaction,distance=..3,type=interaction] run summon minecraft:interaction ^ ^2 ^3.5 {Tags:["reload_interaction","reload_prompt"],width:0.5f,height:0.5f}
